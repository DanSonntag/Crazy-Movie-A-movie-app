    ...
    <Wrapper>
      ...
      <ul className="movie-lists">
        {filteredMovies.length > 0 ? (
          ...
          <h2 style={{ color: "black", fontSize: "20px"}}>No tv-series or shows found matching your search.</h2>
          <p style={{color: "#ffffffa4", opacity: .5}}>You don't either connect to the internet or it is not avaliable</p>
          </div>
        )}
      </ul>
    </Wrapper>
